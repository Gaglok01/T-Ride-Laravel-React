  ...
  return (
    <div className="bg-tride-card border border-tride-border p-6 rounded-3xl relative overflow-hidden hover:bg-tride-hover/30 transition-colors">
      <div className="flex justify-between items-start mb-4">
        <div className="w-10 h-10 bg-tride-hover/50 rounded-xl flex items-center justify-center">{icons[icon]}</div>
        <span
      ...
      <p className="text-xs text-tride-text-muted font-medium mb-1">{title}</p>
