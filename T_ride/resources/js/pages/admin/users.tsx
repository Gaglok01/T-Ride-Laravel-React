    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                ...
                <StatsCard 
                    label="New Today" 
                    value={stats?.new_today?.toString() || "0"} 
                    trend="+15.8%" 
                    trendUp={true} 
                    ...
                    <div className="px-6 py-4 border-t border-white/5 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button 
                                ...
                                className="px-4 py-2 rounded-xl bg-white/5 text-white/70 hover:bg-white/10 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                            >
                                Previous
                            </button>
...
function UserRow({ user, onEdit, onDelete, onToggleStatus, formatDate, formatWallet }: UserRowProps) {
    ...
    return (
        <tr className="hover:bg-white/5 transition-colors group">
            ...
            <td className="px-6 py-4 font-mono text-sm">{formatWallet(user.wallet_balance)}</td>
            <td className="px-6 py-4">
                <button 
